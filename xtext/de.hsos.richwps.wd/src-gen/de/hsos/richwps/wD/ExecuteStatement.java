 ...
 * <ul>
 *   <li>{@link de.hsos.richwps.wD.ExecuteStatement#getHandle <em>Handle</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.ExecuteStatement#getExecinputs <em>Execinputs</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.ExecuteStatement#getExecoutputs <em>Execoutputs</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hsos.richwps.wD.WDPackage#getExecuteStatement()
 * @model
 * @generated
 */
public interface ExecuteStatement extends Operation
{
   ...
   * @see de.hsos.richwps.wD.WDPackage#getExecuteStatement_Handle()
   * @model
   * @generated
   */
  String getHandle();
  ...
  /**
   * Sets the value of the '{@link de.hsos.richwps.wD.ExecuteStatement#getHandle <em>Handle</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.hsos.richwps.wD.ExecInput}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.hsos.richwps.wD.WDPackage#getExecuteStatement_Execinputs()
   ...
   * The list contents are of type {@link de.hsos.richwps.wD.ExecOutput}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.hsos.richwps.wD.WDPackage#getExecuteStatement_Execoutputs()
   * @model containment="true"
   * @generated
   */
