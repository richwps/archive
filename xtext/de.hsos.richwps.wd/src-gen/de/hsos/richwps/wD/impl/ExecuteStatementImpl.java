 ...
 * <ul>
 *   <li>{@link de.hsos.richwps.wD.impl.ExecuteStatementImpl#getHandle <em>Handle</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.impl.ExecuteStatementImpl#getExecinputs <em>Execinputs</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.impl.ExecuteStatementImpl#getExecoutputs <em>Execoutputs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExecuteStatementImpl extends OperationImpl implements ExecuteStatement
{
  ...
  {
    return WDPackage.Literals.EXECUTE_STATEMENT;
  }
  ...
  public void setHandle(String newHandle)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.EXECUTE_STATEMENT__HANDLE, oldHandle, handle));
  }
  ...
  public EList<ExecInput> getExecinputs()
  {
    if (execinputs == null)
    {
      execinputs = new EObjectContainmentEList<ExecInput>(ExecInput.class, this, WDPackage.EXECUTE_STATEMENT__EXECINPUTS);
    }
    return execinputs;
  }
  ...
  public EList<ExecOutput> getExecoutputs()
  {
    if (execoutputs == null)
    {
      execoutputs = new EObjectContainmentEList<ExecOutput>(ExecOutput.class, this, WDPackage.EXECUTE_STATEMENT__EXECOUTPUTS);
    }
    return execoutputs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case WDPackage.EXECUTE_STATEMENT__EXECINPUTS:
        return ((InternalEList<?>)getExecinputs()).basicRemove(otherEnd, msgs);
      case WDPackage.EXECUTE_STATEMENT__EXECOUTPUTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WDPackage.EXECUTE_STATEMENT__HANDLE:
        return getHandle();
      case WDPackage.EXECUTE_STATEMENT__EXECINPUTS:
