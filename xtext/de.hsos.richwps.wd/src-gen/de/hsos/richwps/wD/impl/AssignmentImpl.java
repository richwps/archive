 ...
 * <ul>
 *   <li>{@link de.hsos.richwps.wD.impl.AssignmentImpl#getLefthand <em>Lefthand</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.impl.AssignmentImpl#getRighthand <em>Righthand</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.impl.AssignmentImpl#getVal_s <em>Val s</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.impl.AssignmentImpl#getVal_i <em>Val i</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssignmentImpl extends OperationImpl implements Assignment
{
  ...
  {
    return WDPackage.Literals.ASSIGNMENT;
  }
  ...
  public void setLefthand(String newLefthand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.ASSIGNMENT__LEFTHAND, oldLefthand, lefthand));
  }
  ...
  public void setRighthand(String newRighthand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.ASSIGNMENT__RIGHTHAND, oldRighthand, righthand));
  }
  ...
  public void setVal_s(String newVal_s)
  {
    ...
    val_s = newVal_s;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.ASSIGNMENT__VAL_S, oldVal_s, val_s));
  }
  ...
  public void setVal_i(int newVal_i)
  {
    ...
    val_i = newVal_i;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.ASSIGNMENT__VAL_I, oldVal_i, val_i));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WDPackage.ASSIGNMENT__LEFTHAND:
        return getLefthand();
      case WDPackage.ASSIGNMENT__RIGHTHAND:
        return getRighthand();
      case WDPackage.ASSIGNMENT__VAL_S:
        return getVal_s();
      case WDPackage.ASSIGNMENT__VAL_I:
        return getVal_i();
    }
