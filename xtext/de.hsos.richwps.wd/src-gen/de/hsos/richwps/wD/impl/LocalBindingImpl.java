 ...
 * <ul>
 *   <li>{@link de.hsos.richwps.wD.impl.LocalBindingImpl#getProcessid <em>Processid</em>}</li>
 *   <li>{@link de.hsos.richwps.wD.impl.LocalBindingImpl#getHandle <em>Handle</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LocalBindingImpl extends OperationImpl implements LocalBinding
{
  ...
  {
    return WDPackage.Literals.LOCAL_BINDING;
  }
  ...
  public void setProcessid(String newProcessid)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.LOCAL_BINDING__PROCESSID, oldProcessid, processid));
  }
  ...
  public void setHandle(String newHandle)
  {
    ...
    handle = newHandle;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, WDPackage.LOCAL_BINDING__HANDLE, oldHandle, handle));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case WDPackage.LOCAL_BINDING__PROCESSID:
        return getProcessid();
      case WDPackage.LOCAL_BINDING__HANDLE:
        return getHandle();
    }
