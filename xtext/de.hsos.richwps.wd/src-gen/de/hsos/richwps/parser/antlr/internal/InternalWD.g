...
entryRuleIN_REFERENCE returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getIN_REFERENCERule()); } 
	 iv_ruleIN_REFERENCE=ruleIN_REFERENCE 
	 { $current=$iv_ruleIN_REFERENCE.current.getText(); }  
	 EOF 
;

// Rule IN_REFERENCE
ruleIN_REFERENCE returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRuleOUT_REFERENCE returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getOUT_REFERENCERule()); } 
	 iv_ruleOUT_REFERENCE=ruleOUT_REFERENCE 
	 { $current=$iv_ruleOUT_REFERENCE.current.getText(); }  
	 EOF 
;

// Rule OUT_REFERENCE
ruleOUT_REFERENCE returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
entryRuleVAR_REFERENCE returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getVAR_REFERENCERule()); } 
	 iv_ruleVAR_REFERENCE=ruleVAR_REFERENCE 
	 { $current=$iv_ruleVAR_REFERENCE.current.getText(); }  
	 EOF 
;

// Rule VAR_REFERENCE
ruleVAR_REFERENCE returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
